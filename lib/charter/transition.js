define(function (require) {
  ...
  /**
    ...
    @private
  */
  var Transition = function (config) { this.init(config||{}); };
  ...
  Transition.prototype = {
    ...
    */
    matchContextsToStates: function (contexts) {
      ...
      // Iterate through the provided contexts, preparing an array that
      // is ordered to match the enterStates array.  If any contexts remain
      // when enterStates run out, add parent states.

      // If any contexts remain when the top of the state hierarchy is reached
      // (the State Machine itself), raise an exception.
